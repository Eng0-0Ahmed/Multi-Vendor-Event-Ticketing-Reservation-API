...
def send_confirmation_email(user_id, token_id, email):
    ...
    message= (f"thank you for signing up." f"Click the link to activate your account: {link}")

    send_mail(subject=subject, message=message, from_email="ownerwebsite@gmail.com", recipient_list=[email])
